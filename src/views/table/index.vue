<template>
  <div class="app-container">
    <div style="margin-bottom: 20px">
      <el-input v-model="input1" style="width: 500px" size="medium" placeholder="请输入关键词" type="text" @keyup.enter.native="SelectButton">
        <el-select slot="prepend" v-model="select1" style="width: 110px;color: deepskyblue;" placeholder="请选择">
    ...
    <div id="table-class">
      <el-table
        ...
        <el-table-column label="标题" align="center" >
          <template slot-scope="scope" >
            <div v-html="changetag(scope.$index)"/>
        ...
        <el-table-column label="原文链接" align="center">
          <template slot-scope="scope">
            <img :src="imgurl" style="width: 25px;height: 25px;" @click="changeURL(scope.row)">
          </template>
        </el-table-column>
      ...
      <div class="block">
        <el-pagination :current-page="pagenumber" :total="maxtitle" layout="prev,pager,next" @current-change="currentPaper"/>
      </div>
    </div>
  </div>
</template>
